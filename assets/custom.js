...
function getProductTemplateFromProduct(product) {
 ...
 const compareAtPrice = product.variants[0].compare_at_price;
  const formattedCompareAtPrice = compareAtPrice ? new Intl.NumberFormat("de-DE", {
    style: "currency",
    currency: currencyCode,
    minimumFractionDigits: 2,
    maximumFractionDigits: 2,
  ...
  return `<product-item class="product-item" reveal="" style="opacity: 1"
  ><div class="product-item__image-wrapper">
    <div class="product-item__label-list label-list">
      <span class="label label--highlight">Save €100,00</span>
    </div>
    <a
  ...
  <div class="product-item__info">
    <div class="product-item-meta">
      <a
        href="/products/the-compare-at-price-snowboard"
        data-instant=""
        class="product-item-meta__title"
        >The Compare at Price Snowboard</a
      >
      ...
      <div class="product-item-meta__price-list-container">
        <div class="price-list price-list--centered">
          ...
          <span class="price price--compare">
            <span class="visually-hidden">Regular price</span>${formattedCompareAtPrice}</span
          >
        </div>
      </div>
    </div>
